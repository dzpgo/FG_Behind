...
class ICE_BOX_API AMI_ServiceObserver_servicesStarted : public ::Ice::AMICallbackBase
{
public:
...
class ICE_BOX_API AMI_ServiceObserver_servicesStopped : public ::Ice::AMICallbackBase
{
public:
...
class ICE_BOX_API AMI_ServiceManager_startService : public ::Ice::AMICallbackBase
{
public:
...
class ICE_BOX_API AMI_ServiceManager_stopService : public ::Ice::AMICallbackBase
{
public:
...
class ICE_BOX_API AMI_ServiceManager_addObserver : public ::Ice::AMICallbackBase
{
public:
