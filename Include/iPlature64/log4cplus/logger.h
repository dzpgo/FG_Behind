...
namespace log4cplus {
    ...
    public:
      ...
      // Static Methods
		...
		//ljw add 2009-07-06
		static Logger getThreadInstance(const log4cplus::tstring& name);
		//ljw add 2009-07-14
		static void eraseThreadInstance(const log4cplus::tstring& name);
      ...
      // Non-Static Methods
        ...
        void forcedLog(LogLevel ll, const log4cplus::tstring& message,
                       const char* file=NULL, int line=-1);
public:
        /**2006-8-8 added by xcs */           
        void debug(const log4cplus::tstring& message,const char* file=__FILE__, int line=__LINE__);
        void info(const log4cplus::tstring& message,const char* file=__FILE__, int line=__LINE__);
        void warn(const log4cplus::tstring& message,const char* file=__FILE__, int line=__LINE__);
        void error(const log4cplus::tstring& message,const char* file=__FILE__, int line=__LINE__);
        void fatal(const log4cplus::tstring& message,const char* file=__FILE__, int line=__LINE__);
        /** add end*/                       
	  ...
	  Logger& operator<< (const log4cplus::tstring& );
...
public:
		...
		//2009-06-23 ljw add
		void setLogFileName(const log4cplus::tstring& strLogFileName);
		//2009-06-23 ljw add
		log4cplus::tstring getLogFileName() const;
