...
struct NodeDynamicInfo
{
    ...
    bool operator<(const NodeDynamicInfo& __rhs) const
    {
        ...
        else if(__rhs.adapters < adapters)
        {
            return false;
        }
        return false;
...
class ICE_GRID_API AMI_NodeObserver_nodeInit : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_NodeObserver_nodeUp : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_NodeObserver_nodeDown : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_NodeObserver_updateServer : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_NodeObserver_updateAdapter : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_ApplicationObserver_applicationInit : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_AdapterObserver_adapterInit : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_ObjectObserver_objectInit : public ::Ice::AMICallbackBase
{
public:
...
class ICE_GRID_API AMI_RegistryObserver_registryInit : public ::Ice::AMICallbackBase
{
public:
