    ...
    namespace helpers {
        ...
        public:
          ...
          // constants
			...
			virtual void resetParam(const log4cplus::tstring& logfile);
          // methods
            /**
			...
			Properties getPropertySubsetInsert(const log4cplus::tstring& prefix,const log4cplus::tstring& logfile = LOG4CPLUS_TEXT("")) const;
