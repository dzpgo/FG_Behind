...
namespace log4cplus {
    ...
    public:
      ...
      // Methods
		...
		//ljw add 2009-07-06
		virtual Logger getThreadInstance(const log4cplus::tstring& name);
		//ljw add 2009-07-06
		virtual Logger getThreadInstance(const log4cplus::tstring& name, spi::LoggerFactory& factory);
		//ljw add 2009-07-14
		virtual void eraseThreadInstance(const log4cplus::tstring& name);
    ...
    private:
      ...
      // Methods
		...
		//ljw add 2009-07-06
		virtual Logger getThreadInstanceImpl(const log4cplus::tstring& name, 
			spi::LoggerFactory& factory);
