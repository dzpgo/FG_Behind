...
namespace log4cplus {
    ...
    public:
        ...
        PropertyConfigurator(const log4cplus::tstring& propertyFile,
                             Hierarchy& h = Logger::getDefaultHierarchy(),
							  const log4cplus::tstring& logfile = LOG4CPLUS_TEXT("")
							 );
         ...
         * </code>
         */
        static void doConfigure(const log4cplus::tstring& configFilename,const log4cplus::tstring& logfile,
                                Hierarchy& h = Logger::getDefaultHierarchy());

		//ljw add 2009-05-22
		//static void doThreadConfigure(const log4cplus::tstring& configFilename, const log4cplus::tstring& logfile,
								//Hierarchy& h = Logger::getDefaultHierarchy());

		//ljw add 2009-11-24
		static void doMultiConfigure(const log4cplus::tstring& loggerName, const log4cplus::tstring& configFilename, const log4cplus::tstring& logfile,
			Hierarchy& h = Logger::getDefaultHierarchy());
         ...
         */
        virtual void configure(const log4cplus::tstring& logfile = "");
    ...
    protected:
      // Methods
		...
		//2009-06-23 ljw modify
        void configureLoggers(const log4cplus::tstring& strLogFileName);
        void configureLogger(log4cplus::Logger logger, const log4cplus::tstring& config);
		//void configureAppenders();
        void configureAppenders(const log4cplus::tstring& logfile= "");
		//ljw add 2011-01-13
		void configureAppenders(const log4cplus::tstring& logfile, const log4cplus::tstring& logName);
		...
		//ljw add 2009-05-22
		//void threadInit(const log4cplus::tstring& logfile); 

		//ljw add 2009-11-24
		void multiInit(const log4cplus::tstring& loggerName, const log4cplus::tstring& logfile); 
		//ljw add 2011-01-13
		log4cplus::tstring filterFileNmae(const log4cplus::tstring& logfile);
		//ljw add 2011-01-13
		void getConfig(const log4cplus::tstring& strLogFileName, log4cplus::tstring& strConfig);
		//ljw add 2011-01-13
		void tstring2Array(log4cplus::tstring& strConfig, std::vector<log4cplus::tstring>& tokens);
      ...
      // Data
		...
		//log4cplus::tstring& logfile;//added by xcs
    private:
      // Disable copy
