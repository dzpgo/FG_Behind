...
void MsgUL01::HandleMessage(const string strValue, const string logFileName)
{
	...
	{
		//strValue格式：
		//KEY_MessageNo,KEY_CraneNo,KEY_ActionType,KEY_CraneX,KEY_CraneY, orderNO,areaType,areaNO，
		...
		if (false == SQL4Parking::SelScanNO4Mat(keyTreatmentNo))
		{
		...
		string areaType = kValues[6];
		string areaNO = kValues[7];
		...
		{
			KEY_PointX1 = kValues[8];
			KEY_PointY1 = kValues[9];
			KEY_PointZ1 = kValues[10];
			KEY_PointX2 = kValues[11];
			KEY_PointY2 = kValues[12];
			KEY_PointZ2 = kValues[13];
			KEY_PointX3 = kValues[14];
			KEY_PointY3 = kValues[15];
			KEY_PointZ3 = kValues[16];
			KEY_PointX4 = kValues[17];
			KEY_PointY4 = kValues[18];
			KEY_PointZ4 = kValues[19];
		}
		...
		if (KEY_MessageNo == "1001" && KEY_ActionType == "1")
		{
			SQL4Parking::InsParkingSRSMatInfo2(keyTreatmentNo,
																				areaType, 
																				areaNO, 
																				orderNO, 
																				KEY_MessageNo, 
		...
		if (KEY_MessageNo == "1001" && KEY_ActionType == "0" || KEY_MessageNo == "1003" && KEY_ActionType == "0" || KEY_MessageNo == "1003" && KEY_ActionType == "1" )
		{
			SQL4Parking::InsParkingSRSMatInfo(keyTreatmentNo,
																			areaType, 
																			areaNO, 
																			orderNO, 
																			KEY_MessageNo, 
