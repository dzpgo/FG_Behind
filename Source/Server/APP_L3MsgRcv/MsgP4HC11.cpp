...
MsgP4HC11*  MsgP4HC11::m_pMsgP4HC11 = NULL;
...
MsgP4HC11* MsgP4HC11::getInstance(void)
{
	if (m_pMsgP4HC11 == NULL)
	{
		m_pMsgP4HC11 = new MsgP4HC11;
	}
	return m_pMsgP4HC11;
}

ByteSeq MsgP4HC11::HandleMessage(const ByteSeq& ParamBuffer, const string& LogFileName)
{
	string functionName="MsgP4HC11 :: HandleMessage()";
	ByteSeq ret;
...
void MsgP4HC11::HandleDataIntoDB(SmartData sd)
{
	string functionName="MsgP4HC11 :: HandleDataIntoDB()";
...
void MsgP4HC11::BandCarPlanInfo(SmartData sd, L3PlanInfo planInfo, string assignFlag, string assignWorkType)
{
	string functionName="MsgP4HC11 :: BandCarPlan()";
	LOG log(functionName, AUTO_CATCH_PID);
...
string MsgP4HC11::GetL3PlanType(SmartData sd)
{
	string functionName="MsgP4HC11 :: GetL3PlanType()";
	LOG log(functionName, AUTO_CATCH_PID);
...
bool MsgP4HC11::SrcInfoNotChange(L3PlanInfo planInfo, SmartData sd)
{
	string functionName="MsgP4HC11 :: SrcInfoNotChange()";
	LOG log(functionName, AUTO_CATCH_PID);
	bool ret = false;
...
bool MsgP4HC11::DstInfoNotChange(L3PlanInfo planInfo, SmartData sd)
{
	string functionName="MsgP4HC11 :: DstInfoNotChange()";
	LOG log(functionName, AUTO_CATCH_PID);
	bool ret = false;
...
bool MsgP4HC11::CarNONotChange(L3PlanInfo planInfo, SmartData sd)
{
	string functionName="MsgP4HC11 :: CarNONotChange()";
	LOG log(functionName, AUTO_CATCH_PID);
	bool ret = false;
...
//检查是否需要重新编辑 车辆信息绑定表
void MsgP4HC11::CheckZCSrcInfo(L3PlanInfo planInfo, SmartData sd, string& planValid)
{
	string functionName="MsgP4HC11 :: CheckZCSrcInfo()";
	LOG log(functionName, AUTO_CATCH_PID);
...
//检查是否需要重新编辑 车辆信息绑定表
void MsgP4HC11::CheckXLDstInfo(L3PlanInfo planInfo, SmartData sd, string& planValid)
{
	string functionName="MsgP4HC11 :: CheckXLDstInfo()";
	LOG log(functionName, AUTO_CATCH_PID);
...
//检查是否需要删除 车辆计划信息绑定表
void MsgP4HC11::CheckWorkProg(L3PlanInfo planInfo, string workType, string& planValid)
{
	string functionName="MsgP4HC11 :: CheckWorkProg()";
	LOG log(functionName, AUTO_CATCH_PID);
...
void MsgP4HC11::CanXLStartNotify(SmartData sd)
{
	string functionName="MsgP4HC11 :: CanXLStartNotify()";
	LOG log(functionName, AUTO_CATCH_PID);
...
bool MsgP4HC11::EVTagSnd(string tagName, string tagValue)
{
	string functionName="MsgP4HC11 :: EVTagSnd()";
	LOG log(functionName, AUTO_CATCH_PID);
	bool ret = false;
	try
	{
