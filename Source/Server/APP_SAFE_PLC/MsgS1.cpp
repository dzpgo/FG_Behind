...
ByteSeq MsgS1::HandleMessage(const ByteSeq& ParamBuffer, SafePLC4EAFYardBase& safePLC4EAFYard_Last)
{
	...
	try
	{
		...
		//1	G1
		log.Debug()<<"\t\t E1="<<sd["E1"].toInt()<<endl;

		//2	G2
		log.Debug()<<"\t\t E2="<<sd["E2"].toInt()<<endl;

		//3	G3
		log.Debug()<<"\t\t E3="<<sd["E3"].toInt()<<endl;

		//4	G4
		log.Debug()<<"\t\t E4="<<sd["E4"].toInt()<<endl;

		//5	G1
		log.Debug()<<"\t\t E5="<<sd["E5"].toInt()<<endl;

		//6	G1
		log.Debug()<<"\t\t E6="<<sd["E6"].toInt()<<endl;

		//7	G1
		log.Debug()<<"\t\t E7="<<sd["E7"].toInt()<<endl;

		//8	G1
		log.Debug()<<"\t\t E8="<<sd["E8"].toInt()<<endl;

		//9	G1
		log.Debug()<<"\t\t E9="<<sd["E9"].toInt()<<endl;

		//10	G1
		log.Debug()<<"\t\t E10="<<sd["E10"].toInt()<<endl;

		//11	G1
		log.Debug()<<"\t\t F1="<<sd["F1"].toInt()<<endl;

		//12	G1
		log.Debug()<<"\t\t F2="<<sd["F2"].toInt()<<endl;

		//13	G1
		log.Debug()<<"\t\t F3="<<sd["F3"].toInt()<<endl;

		//14	G1
		log.Debug()<<"\t\t F4="<<sd["F4"].toInt()<<endl;

		//15	G1
		log.Debug()<<"\t\t F5="<<sd["F5"].toInt()<<endl;

		//16	G1
		log.Debug()<<"\t\t F6="<<sd["F6"].toInt()<<endl;

		//17	G1
		log.Debug()<<"\t\t F7="<<sd["F7"].toInt()<<endl;

		//18	G1
		log.Debug()<<"\t\t F8="<<sd["F8"].toInt()<<endl;

		//19	G1
		log.Debug()<<"\t\t F9="<<sd["F9"].toInt()<<endl;

		//20	G1
		log.Debug()<<"\t\t F10="<<sd["F10"].toInt()<<endl;

		//21	G1
		log.Debug()<<"\t\t F11="<<sd["F11"].toInt()<<endl;

		//22	G1
		log.Debug()<<"\t\t F12="<<sd["F12"].toInt()<<endl;

		//23	G1
		log.Debug()<<"\t\t F13="<<sd["F13"].toInt()<<endl;

		//24	G1
		log.Debug()<<"\t\t F14="<<sd["F14"].toInt()<<endl;
