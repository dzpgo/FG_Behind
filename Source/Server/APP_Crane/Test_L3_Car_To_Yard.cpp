...
Test_L3_Car_To_Yard::Test_L3_Car_To_Yard(void )
{
...
bool Test_L3_Car_To_Yard::Test(string craneNO, OrderCurrentBase orderCurrent ,CranePLCStatusBase cranePLCStatusBase)
{

	bool ret=false;

	string functionName="Test_L3_Car_To_Yard::Test";
